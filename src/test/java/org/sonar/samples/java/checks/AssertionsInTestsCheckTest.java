/*
 * From org.sonar.java.checks.tests.AssertionsInTestsCheckTest.java of sonar-java-7.34.0.35958
 */
...
*/
  ...
  void testSpringBootSanity(){
    CheckVerifier.newVerifier()
      .onFile(FILES_PATH + "SpringBootSanityTestSample.java")
      .withCheck(check)
      .verifyIssues();

    CheckVerifier.newVerifier()
      .onFile(FILES_PATH + "SpringBootSanityJ4Test.java")
      .withCheck(check)
      .verifyIssues();
  }
